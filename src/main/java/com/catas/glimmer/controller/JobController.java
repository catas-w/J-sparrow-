...
import com.catas.glimmer.JobEntityRepository;
import com.catas.glimmer.dto.ModifyCronDTO;
import com.catas.glimmer.entity.JobEntity;
import com.catas.glimmer.service.DynamicJobService;
...
public class JobController {
    ...
    // public String stop(@PathVariable Integer id) throws SchedulerException {
    //     Scheduler scheduler = schedulerFactoryBean.getScheduler();
    //     JobEntity entity = jobService.getJobEntityById(id);
    //     JobKey jobKey = jobService.getJobKey(entity);
    //     scheduler.pauseJob(jobKey);
    ...
    // public String resume(@PathVariable Integer id) throws SchedulerException {
    //     Scheduler scheduler = schedulerFactoryBean.getScheduler();
    //     JobEntity entity = jobService.getJobEntityById(id);
    //     JobKey jobKey = jobService.getJobKey(entity);
