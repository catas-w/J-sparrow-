...
layui.define(["form", 'element'], function (exports) {
  ...
  Class.prototype.render = function () {
    ...
    var $elemCron = (that.$elemCron = $('<div class="layui-cron" id="cron-ele"></div>')),
      // 主区域
      elemMain = [], // tabs容器
    ...
    var elemFooter = [
      ...
      '<div class="cron-box"><div class="cron-footer-btns"><span lay-type="run" class="cron-btns-run">取消</span><span lay-type="confirm" class="cron-btns-confirm">确定</span></div></div>',
    ];
